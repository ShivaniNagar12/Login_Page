...
root.resizable(0,0)
bg = Image.open('pexels-fauxels-3183132.jpg')
...
def new():
    if user_entry.get()=="":
        messagebox.showinfo("Login System", "Please enter the uername")
    elif password_entry.get()=="":
        messagebox.showinfo("Login System", "Please enter the password")
    elif user_entry.get()=="" and  password_entry.get()=="":
        messagebox.showinfo("Login System", "Please enter username and password")
        ...
        home = Button(new_window, text="Go to the login page", font="Ariel 22 bold", relief=GROOVE, bd=2, command=home_page)
...
label = Label(root, text="Login Page", font=("Ariel 22 bold"), bg='#5500FF', fg='white')
canvas.create_window(260, 40, anchor="nw", window=label)

user_label = Label(root, text="User_Name", font=("Ariel 22 bold"), bg='#5500FF', fg='white')
canvas.create_window(140, 130, anchor="nw", window=label)

password_label = Label(root, text="Password", font=("Ariel 22 bold"), bg='#5500FF', fg='white')
canvas.create_window(140, 210, anchor="nw", window=label)
